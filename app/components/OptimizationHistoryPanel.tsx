...
export function OptimizationHistoryPanel(props: {
  ...
  const showWeeklyMonitoringPanel = plan !== "free";
  ...
  return (
    <div style={{ marginTop: 24 }}>
      <div
        style={{
          display: "grid",
          gridTemplateColumns: showWeeklyMonitoringPanel ? "1.2fr 1fr" : "1fr",
          gap: 16,
          alignItems: "start",
        }}
      >
        {showWeeklyMonitoringPanel ? (
          <div
            style={{
              background: "#fff",
          ...
          >
            {plan === "growth" ? (
              ...
              <>
                ...
                <div
                  style={{ color: "#4b5563", fontSize: 14, lineHeight: 1.6 }}
                >
